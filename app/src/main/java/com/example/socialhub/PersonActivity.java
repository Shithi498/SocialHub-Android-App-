...
import com.example.socialhub.Adapter.FriendsAdapter;
...
public class PersonActivity extends AppCompatActivity {
    ...
    TextView name;
    TextView prof,friendsCount,about,imgNum;
    Button back;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        prof = findViewById(R.id.profession1);
        ...
        database.getReference().child("User").child(auth.getUid()).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if(snapshot.exists()){
                    ...
                    imgNum.setText(model.getPostImageNum()+"");
